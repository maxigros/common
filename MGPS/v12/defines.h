...
////////
#define CMD_META_POS		0x55	// Команда на запрос серийного номера устройства, чтение
#define SZRX_META_POS     3		// Размер командного сообщения
#define SZTX_META_POS     8		// Размер ответного сообщения
////////
...
#define CMD_DEV_STATUS		0x10	// Байт статуса устройства, чтение
