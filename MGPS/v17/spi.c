...
{
	unsigned long int all_space_pages = SPI_PAGES_NUM - 1;
    unsigned long int busy_space_pages = ((int)b1 << 8) | (int)b2;
	return (unsigned long int)((all_space_pages - busy_space_pages) * SPI_PAGE_SIZE);
}
//----------------------------------------------------------------------------------------------
