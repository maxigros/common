#ifndef CP9B_CLIENT_EXT_H
#define CP9B_CLIENT_EXT_H

#include "cp9b_client.h"
#include <QTimer>


class cp9b_client_ext : public cp9b_client
{
    Q_OBJECT
public:
    explicit cp9b_client_ext(QObject *parent = 0);
...
private:
    ...
    void handle_received_package(char* buf, int size);
    void timers_stop();
